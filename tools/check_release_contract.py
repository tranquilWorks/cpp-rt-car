...
HASHED_CONTRACT_PATHS = {
    ...
    'bench/providers/runtime_cases/checkpoint.cpp',
    'bench/providers/runtime_cases/control_support.hpp',
    'bench/providers/runtime_cases/controls.cpp',
    'bench/providers/runtime_cases/device.cpp',
    'bench/providers/runtime_cases/observability.cpp',
    'bench/providers/runtime_cases/rates.cpp',
    'bench/providers/runtime_cases/replay.cpp',
    'bench/providers/runtime_cases/support.hpp',
    'bench/providers/runtime_provider.cpp',
    'bench/providers/runtime_provider.hpp',
    'tests/benchmark_fixtures/runtime_consumer/CMakeLists.txt',
    'tests/benchmark_fixtures/runtime_consumer/noalloc.cpp',
    'tests/benchmark_fixtures/runtime_consumer/replay_regression.cpp',
    'tests/benchmark_fixtures/runtime_consumer/verify_package.py',
    'tests/benchmark_fixtures/test_runtime_cases.py',
    'tests/package_consumer/benchmark_runtime_consumer.cpp',
    'tests/test_benchmark_runtime.cpp',
